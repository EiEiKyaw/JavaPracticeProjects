...
@ComponentScan({ "com.customer.example" })
@EnableJpaRepositories("com.customer.example.repository")
public class PersistanceJpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] { "com.customer.example.model" });
